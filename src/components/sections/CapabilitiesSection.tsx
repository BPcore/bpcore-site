...
export function CapabilitiesSection() {
    return (
        <section className="py-24 px-6 md:px-12 max-w-7xl mx-auto space-y-24">
                            ...
                            <tbody className="text-zinc-300">
                                {[
                                    ...
                                    <tr key={i} className="border-b border-zinc-800 last:border-0 hover:bg-zinc-900/30 transition-colors">
                                        ...
                                        <td className="p-4 text-emerald-400/80">{impact}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                        ...
                        <table className="w-full text-left border-collapse text-sm">
                            <thead>
                                <tr className="bg-zinc-900/80 text-zinc-100 border-b border-zinc-800">
                                    ...
                                    <th className="p-4 font-semibold">Legacy IP Approach</th>
                                    <th className="p-4 font-semibold">NeuraEdge™ Solution</th>
                                </tr>
                            </thead>
                            <tbody className="text-zinc-300">
                                {[
                                    ...
                                    <tr key={i} className="border-b border-zinc-800 last:border-0 hover:bg-zinc-900/30 transition-colors">
                                        <td className="p-4 font-medium text-white">{chal}</td>
                                        <td className="p-4 text-red-400/70">{legacy}</td>
                                        <td className="p-4 text-emerald-400 font-medium">{sol}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
            ...
            <GlassCard className="p-8 md:p-12 text-center space-y-8 border-emerald-500/30 bg-emerald-900/10">
                ...
                <div className="pt-4">
                    <Link href="/contact">
                        <Button size="lg" className="bg-emerald-500 hover:bg-emerald-600 text-white rounded-full px-8 h-12 text-base font-medium">
