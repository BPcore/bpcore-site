                            ...
                            <table className="w-full text-sm text-left">
                                ...
                                <tbody className="divide-y divide-border">
                                    <tr className="bg-secondary/20 hover:bg-secondary/40 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-zinc-600 dark:text-zinc-300">+37%</td>
                                        <td className="px-6 py-4 text-muted-foreground">3-stage</td>
                                    ...
                                    <tr className="bg-secondary/20 hover:bg-secondary/40 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-zinc-600 dark:text-zinc-300">+78%</td>
                                        <td className="px-6 py-4 text-muted-foreground">3-stage</td>
                                        <td className="px-6 py-4">
                                            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-emerald-500/10 text-emerald-500 border border-emerald-500/20">
                                                Signoff-Ready
                        ...
                        <div className="mt-auto pt-6 space-y-4">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {["POWER_AREA_ANALYSIS_3STAGE.md", "CI_100MHZ_VALIDATION.md", "sta_timing_roadmap.md"].map((doc, i) => (
                                    <div key={i} className="flex items-center gap-1 px-2 py-1 rounded bg-secondary/50 border border-border text-xs text-muted-foreground">
                    ...
                    <GlassCard className="h-full flex flex-col justify-between">
                        ...
                        <div className="flex-1 flex items-center justify-center py-4">
                            <div className="text-center">
                                <div className="text-4xl font-bold text-foreground mb-1">62%</div>
                ...
                <div className="md:col-span-1 row-span-1">
                    <GlassCard className="h-full flex flex-col">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h3 className="text-lg font-medium text-foreground">Production Validation</h3>
                        </div>
