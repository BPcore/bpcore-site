...
export function BuyersSection() {
    return (
        <section className="py-24 px-6 md:px-12 max-w-7xl mx-auto space-y-16">
                            ...
                            <tbody className="text-zinc-300">
                                {[
                                    ...
                                    <tr key={i} className="border-b border-zinc-800 last:border-0 hover:bg-zinc-900/30 transition-colors">
                                        <td className="p-4 font-medium text-zinc-100">{category}</td>
                        ...
                        <ul className="space-y-4">
                            {[
                                ...
                                <li key={i} className="flex gap-3 text-zinc-300 text-sm">
                                    <span className="flex-shrink-0 w-6 h-6 rounded-full bg-zinc-800 flex items-center justify-center text-xs font-mono text-zinc-400 border border-zinc-700">
                                        {i + 1}
                                    </span>
                                    <span>{item}</span>
                                </li>
                            ...
                            <table className="w-full text-left border-collapse text-sm h-full">
                                ...
                                <tbody className="text-zinc-300">
                                    {[
                                        ...
                                        <tr key={i} className="border-b border-zinc-800 last:border-0 hover:bg-zinc-900/30 transition-colors">
                                            <td className="p-4 font-medium text-zinc-100">{need}</td>
                                            <td className="p-4 text-red-400/80">{pain}</td>
                                            <td className="p-4 text-emerald-400/80">{relief}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
                    ...
                    <GlassCard className="p-8">
                        <div className="prose prose-invert prose-sm">
                            <p className="text-zinc-300 leading-relaxed">
                                Request: <span className="text-emerald-400">sanitized RTL subset</span>, workload matrix, golden digests, timing snapshot.
                            </p>
                            <div className="flex items-center gap-4 my-6 p-4 bg-zinc-900/50 rounded-lg border border-zinc-800">
                                <div className="text-center">
                                    <div className="text-xs text-zinc-500 uppercase tracking-wider mb-1">Run Time</div>
                                    <div className="text-xl font-mono text-white">&lt; 2 min</div>
                                </div>
                                <div className="h-8 w-px bg-zinc-800" />
                                <div className="flex-1">
                                    <div className="text-sm text-zinc-300">Run <code className="text-emerald-400">protocol_flow</code> & <code className="text-emerald-400">protocol_micro</code></div>
                                    <div className="text-xs text-zinc-500">Inspect CSV evidence → Proceed</div>
                                </div>
                            </div>
                        </div>
                    </GlassCard>
                        ...
                        <table className="w-full text-left border-collapse text-sm">
                            ...
                            <tbody className="text-zinc-300">
                                {[
                                    ...
                                    <tr key={i} className="border-b border-zinc-800 last:border-0 hover:bg-zinc-900/30 transition-colors">
                                        <td className="p-4 font-medium text-zinc-100">{tier}</td>
                        ...
                        <table className="w-full text-left border-collapse text-sm">
                            ...
                            <tbody className="text-zinc-300">
                                {[
                                    ...
                                    <tr key={i} className="border-b border-zinc-800 last:border-0 hover:bg-zinc-900/30 transition-colors">
                                        <td className="p-4 font-mono text-xs text-emerald-400">{artifact}</td>
            ...
            {/* Differentiators */}
            <div className="space-y-6">
                <h3 className="text-2xl font-semibold text-white">Differentiators Snapshot</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {[
                        ...
                        <GlassCard key={i} className="p-6">
                            <div className="text-sm text-zinc-500 uppercase tracking-wider mb-2">{dim}</div>
                            <div className="font-medium text-white">{adv}</div>
                        </GlassCard>
                    ))}
                </div>
            </div>
            ...
            <div className="text-center space-y-8 pt-8 border-t border-zinc-800">
                <h3 className="text-2xl font-bold text-white">Ready to Evaluate?</h3>
                <p className="text-zinc-400 max-w-2xl mx-auto">
                    Email <a href="mailto:info@bpcore-silicon.com" className="text-emerald-400 hover:text-emerald-300 transition-colors">info@bpcore-silicon.com</a> with subject “NeuraEdge Evaluation Request” to receive the optional evaluation pack or initiate full acquisition.
                </p>
